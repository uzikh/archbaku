...
function Xidmetler() {
  return (
    <>
      <div className="xidmetler-section-top">
        <div className="xidmetler-top-content">
          <h1>
            <span className="vertical-line">│</span>&nbsp;&nbsp;XİDMƏTLƏR
          </h1>
          <p className="xidmetler-top-content-text">
            <span className="xidmetler-top-content-text-span">Əsas Səhifə</span>
            &nbsp;&nbsp; > &nbsp; Xidmətlər
          </p>
        </div>
      </div>
      <div className="xidmetler">
        ...
        <div className="xidmetler-row1">
          <div className="xidmetler-main">
            <div className="xidmetler-main2">
              ...
              <p className="xidmetler-main-p">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id sem
                mattis pulvinar lacus. Viverra erat aenean orci tristique
                pellentesque iaculis aliquam. Malesuada ornare nisi, sit id eget
                elit ullamcorper.
              </p>
        ...
        <div className="xidmetler-row2">
          ...
          <div className="xidmetler-main">
            {" "}
            <div className="xidmetler-main2 uzeir">
          ...
          <div className="xidmetler-main">
            <div className="xidmetler-main2">
              ...
              <h4 className="xidmetler-main-title">
